...
&ensp;&ensp;&ensp;&ensp;&ensp;&ensp; Os gráficos foram criados usando o pacote ggplot2[-@ggplot2] e a animação feita com gganimate[-@gganimate] no R. A espiral climática foi grandemente inspirada pela visualização feita por Ed Hawkins [-@TheClimateSpiralDemonstratesthePowerofSharingCreativeIdeas], que se tornou muito popular por um conjunto de motivos, mas principalmente pela sua combinação de criatividade, design e *storytelling*.
